...
namespace libicp {
    ...
    public:
        ...
        IcpPointToPlane(const double *M, const int32_t M_num, const int32_t dim, const int32_t num_neighbors = 10,
                        const double flatness = 5.0) : Icp(M, M_num, dim) {
    ...
    private:
        ...
        double fitStep(const double *T, const int32_t T_num, Matrix &R, Matrix &t, const std::vector<int32_t> &active);

        std::vector<int32_t> getInliers(const double *T, const int32_t T_num, const Matrix &R, const Matrix &t,
                                        const double indist);
