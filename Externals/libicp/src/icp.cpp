...
using namespace std;
namespace libicp {
    Icp::Icp(const double *M, const int32_t M_num, const int32_t dim) :
    ...
    int Icp::fit(const double *T, const int32_t T_num, Matrix &R, Matrix &t, const double indist) {
...
//  fitIterate(T,T_num,R,t,active);
    ...
    void Icp::fitIterate(const double *T, const int32_t T_num, Matrix &R, Matrix &t,
